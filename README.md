...
2. `git clone git@github.com:INN/umbrella-mwcir.git`
...
9. Search and replace 'mwcir.wpengine.com' --> 'investigatemidwest.dev' in the db (options for doing this are covered in the [largo umbrella setup instructions](https://github.com/INN/docs/blob/master/projects/largo/umbrella-setup.md)
