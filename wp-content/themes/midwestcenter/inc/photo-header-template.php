...
/**
 * Given an attachment ID, generate an opening <div> tag with an inline style attribute
 * The inline style="" contains the background-image information for the photo header.
 * The closing </div> tag is assumed to be present elsewhere in the markup.
 * @param WP_Post|int the attachment image's post or ID
 * @return string HTML
 */
function mwcir_photo_header_tag( $post = null ) {
